...
module.exports=async(req,res)=>{
  ...
  const u=`https://apis.data.go.kr/1611000/nsdi/LandCharacterService/attr/getLandCharacterAttr?serviceKey=${k}&pnu=${req.query.pnu}&numOfRows=1&pageNo=1&resultType=json`;
