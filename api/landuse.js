...
module.exports = async (req, res) => {
  ...
  const url = `https://apis.data.go.kr/1611000/nsdi/LandUseService/attr/getLandUseAttr?serviceKey=${key}&pnu=${req.query.pnu}&numOfRows=20&pageNo=1&resultType=json`;
  try {
